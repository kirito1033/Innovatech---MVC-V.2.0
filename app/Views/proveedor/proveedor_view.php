  ...
  <body>
    ...
    <?php require_once("../app/Views/nav/navbar.php")?>
      ...
      <button type="button" class="btn btn-primary" onclick="add()" style="font-size: 0.5em;"><img src ="../assets/img/icons/person-add.svg" style="color: white" ></button>
			<!--Container Table-->
      <?php require_once("../app/Views/proveedor/table.php")?>
    </div>
		<!--Footer-->
    ...
    <div class="modal fade" id="my-modal" tabindex="-1" aria-labelledby="my-modalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <?php require_once("../app/Views/proveedor/form.php") ?>
        </div>
    ...
    <script src="<?=base_url("controllers/proveedor/proveedor.js") ?>"></script>
