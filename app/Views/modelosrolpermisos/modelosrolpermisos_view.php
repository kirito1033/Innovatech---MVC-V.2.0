<?php
// Verificamos si el usuario tiene permisos por ID directamente
$puedeVer = isset($permisos_usuario[1]);
$puedeEditar = isset($permisos_usuario[2]);
$puedeEliminar = isset($permisos_usuario[3]);
$puedeCrear = isset($permisos_usuario[4]);
?>
