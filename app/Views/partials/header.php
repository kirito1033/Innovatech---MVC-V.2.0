...
<head>
  ...
  <!-- Iconos de Font Awesome y Bootstrap Icons -->
  ...
  <header class="header">
    <nav class="header_nav">
      <ul class="header__nav-ul">
        <!-- Ícono menú hamburguesa y búsqueda (modo móvil) -->
        <li class="header__nav-li">
          <form class="header__nav-li--form">
            <!-- Botón para abrir menú lateral (offcanvas) -->
...
<!-- Script: Lógica del buscador -->
<script>
  // Permite usar Enter para ejecutar la búsqueda
  ...
  // Función que redirige al resultado de búsqueda por nombre
