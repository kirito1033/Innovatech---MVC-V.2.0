...
<form id="formPayU" method="post" action="https://sandbox.checkout.payulatam.com/ppp-web-gateway-payu/">
  ...
  <!-- Rutas a crear -->
  <input name="responseUrl"   type="hidden" value="https://707d-179-51-111-180.ngrok-free.app/facturas/respuesta">
  <input name="confirmationUrl" type="hidden" value="https://707d-179-51-111-180.ngrok-free.app/facturas/confirmacion">
</form>
